...
- [x] 1. Script valide place dans script.xlsx
...
- [ ] 8. Base assemblee : python studio.py build EMO07_VID01
...
- [ ] 11. Rendu final : python studio.py render EMO07_VID01
