...
```
python emo.py new EMO15_VID01 --script "chemin/vers/EMO15_VID01.xlsx"
```
...
```
python emo.py build EMO15_VID01
```
...
```
python emo.py render EMO15_VID01
```
...
| Je ne sais plus où j'en suis | `python emo.py status` |
